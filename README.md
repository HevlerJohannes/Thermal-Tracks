...
Johannes F. Hevler, Shivam Verma, Mirat Soijtra, Carolyn R. Bertozzi (2025), *Thermal-Tracks: A Gaussian process-based framework for universal melting curve analysis enabling unconstrained hit identification in thermal proteome profiling experiment*. arXiv:2508.09659. — [Abstract](https://arxiv.org/abs/2508.09659) · [PDF](https://arxiv.org/pdf/2508.09659v1)
...
## Run Thermal Tracks
Thermal Tracks can be run through Jupyter notebooks or via the terminal. Example analysis notebooks are available in the [Analysis_notebooks](./Analysis_notebooks) folder.

To run via the terminal:

```bash
python main.py -i input.csv -p params.json
```
...
**Coming soon:**
- Comprehensive installation and usage tutorial
- Standalone executable for simplified use
