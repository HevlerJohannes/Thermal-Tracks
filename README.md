...
Johannes F. Hevler, Shivam Verma, Mirat Soijtra, Carolyn R. Bertozzi(2025), *Thermal Tracks: A Gaussian process-based framework for universal melting curve analysis enabling unconstrained hit identification in thermal proteome profiling experiments* — [abstract](https://arxiv.org/abs/2508.09659) · [PDF v1](https://arxiv.org/pdf/2508.09659v1)
